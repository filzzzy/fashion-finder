...
| --------------------------------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------------------------------- |
| `data/fashion_iq/images/B009ZD7XLC.jpg` (платье с короткими рукавами) | `"have longer sleeves and a darker color"` | `data/fashion_iq/images/B003GUI9MA.jpg` (платье с длинными рукавами в тёмном тоне) |
